...
* Διανομή **ΜΕ** γραφικό περιβάλλον εργασίας χρήστη (LXDE) <A href="https://github.com/prassaschr/samba4HPS/releases"> 64bit </A> 
...
* Distribution **WITH** graphical user interface (LXDE) <A href="https://github.com/prassaschr/samba4HPS/releases"> 64bit </A>
