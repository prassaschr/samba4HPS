...
**Τι περιέχεται στο εκκινήσιμο ISO; Δείτε παρακάτω...** (βασισμένο στην έκδοση Debian Linux 9.0.1 CD 64bit)
...
**What's in the bootable iso? Check below...** (based on Debian Linux 9.0.1 CD 64bit)
