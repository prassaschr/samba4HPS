...
... γιατί ένας **ασφαλές**, εύκολα διαχειρίσιμος και **δωρεάν** File Server είναι παραπάνω από απαραίτητος για τις μεσαίου και μεγάλου μεγέθους Δημόσιες Υπηρεσίες...
...
**Τι περιέχεται στο εκκινήσιμο ISOq; Δείτε παρακάτω...** (βασισμένο στην έκδοση Debian Linux 9.0.1 netinstall 64bit)
