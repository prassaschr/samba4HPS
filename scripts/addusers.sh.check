...
WIDTH=40
CHOICE_HEIGHT=4
BACKTITLE="Προσοχή!!! Απαιτείται έλεγχος!"
TITLE="ΠΡΟΣΟΧΗ!"
MENU="Έχετε ελέγξει το αρχείο χρηστών /home/smbadmin/addusers.csv???"
...
then
  ...
  echo "Finish. $created accounts inserted to your server."
        ...
        2)
            echo "Ελέγξτε το αρχείο με τα δεδομένα χρηστών και επανεκτελέστε το εκτελέσιμο αρχείο...."
            ;;
esac
